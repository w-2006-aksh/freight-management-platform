...
const {
  handleSignUp,
} = require("../../controllers/transporterControllers/signUp");
const {
  handleLogin,
} = require("../../controllers/transporterControllers/login");
const formDataValidator = require("../../middleware/formDataValidator");
const crypto = require("crypto");
const {
  transporterSignUpSchema,
} = require("../../formDataValidate/transporter/signUp");
