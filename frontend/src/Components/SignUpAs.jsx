...
function LoginAs() {
  return (
    ...
    <h1 className="font-semibold text-5xl">Who are you?</h1>
        ...
        <Link className=" h-[110px] w-[170px] rounded-xl bg-white  flex flex-col gap-y-2 justify-center items-center hover:scale-[1.05] transition py-4 px-4" to="/signUpAsClient">
        ...
        <Link className="h-[110px] w-[170px] rounded-xl bg-white py-4 px-4 flex flex-col gap-y-2 justify-center items-center hover:scale-[1.05] transition" to="/signUpAsTransporter">
